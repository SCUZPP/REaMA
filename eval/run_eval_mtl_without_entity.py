...
def main(args):
    ...
    if "chemprot" in args.data_dir: 
        prompt_discribe = "Activation, Inhibition, Agonist, Antagonist, Substrate, None-Chem"
        cloze = "The relation between @CHEMICAL$ and @GENE$ is"
    elif "gad" in args.data_dir: 
        prompt_discribe = "None, Association"
        cloze = "The relation between @GENE$ and @DISEASE$ is"
        #prompt_discribe = ""
        #cloze = ""
    elif "euadr" in args.data_dir: 
        prompt_discribe = "None, Association"
        cloze = "The relation between @GENE$ and @DISEASE$ is"
    elif "hprd" in args.data_dir: 
        prompt_discribe = "None-HPRD50, HPRD-Association"
        cloze = "The relation between @GeneSrc$ and @GeneTgt$ is"
    elif "aimed" in args.data_dir: 
        prompt_discribe = "None-AIMED, AIMED-Association"
        cloze = "The relation between @GeneSrc$ and @GeneTgt$ is"


    prompt_prefix = "The following is a text from the biomedical literature where specific entities are replaced by entity types. Please select the one from '%s' that correctly describe the relationship between the two entities.\n\n" % prompt_discribe
